...
namespace IT15_Final_Proj.Services
{
    public class PayMongoService
    {
            ...
            var payload = new
            {
                data = new
                {
                    attributes = new
                    {
                        ...
                        success_url = $"https://logisticshub.runasp.net/Vendor/Transactions?requestId={requestId}",
                        cancel_url = "https://logisticshub.runasp.net/Vendor/Products"
                    }
                }
            };
        ...
        )
        {
            ...
            var successUrl = $"https://logisticshub.runasp.net/Customer/OrderSuccess?vendorEmail={vendorEmail}&customerEmail={customerEmail}";
            ...
            var payload = new
            {
                data = new
                {
                    attributes = new
                    {
                        ...
                        cancel_url = "https://logisticshub.runasp.net/Customer/CustomerCart"
                    }
                }
            };
